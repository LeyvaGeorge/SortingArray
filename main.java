public class main {
    public static void main(String [] args) {
        ...
        students[0] = new Student(3, "James", "123 Main St");
        students[1] = new Student(1, "Bob", "456 Elm St");
        students[2] = new Student(5, "Zavier", "789 Oak St");
        students[3] = new Student(2, "David", "321 Maple St");
        students[4] = new Student(4, "Brandon", "654 Pine St");
        ...
        //Todo print out the students name, roll number and address before and after sorting
